...
export class ChairaAuth {
    ...
    public static urlAuthLogin: string = `http://chaira.udla.edu.co/api/v0.1/oauth2/authorize.asmx/auth?response_type=code&client_id=${ChairaAuth.client_id}&redirect_uri=${ChairaAuth.callback_url}&state=xyz
`;
}